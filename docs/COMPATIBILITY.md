...
| 13 | `GET /readyz` with R2 unreachable returns `200` degraded, not `503` | unreleased | Operators and probe readers |
...
## 13 — `GET /readyz` with R2 unreachable returns `200` degraded, not `503`
