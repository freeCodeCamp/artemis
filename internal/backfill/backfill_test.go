...
func (f *fakeIndexer) UpsertDeploy(_ context.Context, site, id string, mtime time.Time, _ int64, hasMarker bool, _ string) error {
	f.deploys = append(f.deploys, idxDeploy{site, id, mtime, hasMarker})
	return nil
}
